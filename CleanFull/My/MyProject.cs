...
namespace CleanFull.My
{
	...
	internal sealed class MyProject
	{
		...
		internal sealed class MyForms
		{
			...
			// (set) Token: 0x06000021 RID: 33 RVA: 0x0000270F File Offset: 0x0000090F
			public Main Form1
			{
				[DebuggerHidden]
				get
				{
					this.m_Form1 = MyProject.MyForms.Create__Instance__<Main>(this.m_Form1);
					return this.m_Form1;
				}
				[DebuggerHidden]
				set
				{
					if (value != this.m_Form1)
					{
						...
						this.Dispose__Instance__<Main>(ref this.m_Form1);
					}
				}
			}
		...
		internal sealed class MyWebServices
		{
			...
			// Token: 0x06000028 RID: 40 RVA: 0x000027DB File Offset: 0x000009DB
			[DebuggerHidden]
			[EditorBrowsable(EditorBrowsableState.Never)]
		...
		internal sealed class ThreadSafeObjectProvider<T> where T : new()
		{
			...
			// (get) Token: 0x06000029 RID: 41 RVA: 0x000027E8 File Offset: 0x000009E8
			...
			// Token: 0x0600002A RID: 42 RVA: 0x0000281A File Offset: 0x00000A1A
			[DebuggerHidden]
			[EditorBrowsable(EditorBrowsableState.Never)]
